...
hold all;
f4=subplot(1,2,1);
plot(f4,accuracy,communication_energy1(14,:),'bs:','MarkerSize',8,'LineWidth',1.5);
hold all;
plot(f4,accuracy,compute_energy1(14,:),'ro--','MarkerSize',6,'LineWidth',1.5);
hold all
...
axes(f3);
plot(f3,accuracy,tot_energy1(14,:),'kX-','MarkerSize',8,'LineWidth',1.5)
hold all
...
set(gca,'FontSize', 14);
axes(f3);
plot(f3,acc_constraint,best_energy,'gx--','MarkerSize',8,'LineWidth',1.5);
hold all
legend(f3,'Weight','Optimum')
axes(f4);
...
set(gca,'FontSize', 14);
axes(f1);
plot(f1,delay_constraint,best_energy_d,'gx-','MarkerSize',8,'LineWidth',1.5);
hold all
axes(f2);
