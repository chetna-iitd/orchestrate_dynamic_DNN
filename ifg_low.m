function [compute_energy1, compute_energy2, communication_energy1, communication_energy2, tot_energy1, tot_energy2] = ifg_low(delay_constraint,accuracy_constraint)
